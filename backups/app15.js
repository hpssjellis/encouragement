   ...
   // console.log(myBig.length)
    ...
    const myMessage = Converter.trytesToAscii(myBig)
     ...
     //  myResponseToTokens(response[myResponseLoop].value, myMessage)
       ...
       if (response[myResponseLoop].value > 0  && response[myResponseLoop].value < 10  ){ global.myResponse2 += '<td>'+ myResponseToTokens(response[myResponseLoop].value, myMessage) }
       if (response[myResponseLoop].value >= 10 ){ global.myResponse2 += '<td>'+ myResponseEncouraging(response[myResponseLoop].value, myMessage) + '</td>'  }
